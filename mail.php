...
$email = 'appleremontsochi@gmail.com, e-17423712@yandex.ru, apple5041.ru@yandex.ru'; // адрес куда отправлять письмо, можно несколько через запятую
...
$password = ''; // пароль приложения вашего почтового ящика
